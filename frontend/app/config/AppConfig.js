...
Ext.define("Realtor.config.AppConfig", {
  statics: {
  ...
  */
  ...
  constructor: function(cfg) {
    if ((cfg != null ? cfg.environment : void 0) && (Realtor.config.AppConfig[cfg.environment] != null)) {
      return this.setEnvironment(Realtor.config.AppConfig[cfg.environment]);
    } else {
      return this.setEnvironment(Realtor.config.AppConfig.PRODUCTION_ENV);
    }
  },
  /**
